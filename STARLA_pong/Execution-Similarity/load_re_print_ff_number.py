...
items = os.listdir('.')
avg_rate = []
final_consistent_ff_count_all = 0
count_all = 0
for re_exe in items[:]:
    # print("\n\n-----------------------------------------------------\n\n")
    if re_exe[:72] == "re_executed-sim-May17_generations_r110_rt400_population1500lastfull_run4":
        ...
        final_consistent_ff_count_all += final_consistent_ff_count
        count_all += len(new_data)
...
print(f'average failure rate {final_consistent_ff_count_all/count_all}')
